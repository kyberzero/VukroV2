...
[🝂] **CHECKED BY** ➺ {username_tg} [PREMIUM]""")
    ...
    if status == "Charged":
        await utils['save_approved_card'](card, "CHARGED (SQ)", res.get('message'), "Shopify Self Charge", "1.00$")
        msg = f"""⍟━━━⌁ **CHARGED** ⌁━━━⍟
...
[🝂] **CHECKED BY** ➺ {username_tg} [PREMIUM]"""
        ...
        await utils['save_approved_card'](card, "APPROVED (SQ)", res.get('message'), "Shopify Self Charge", "N/A")
        msg = f"""⍟━━━⌁ **APPROVED** ⌁━━━⍟
